...
import {callAdded, callRemoved, callRetried, setCallAgent, setCallState, setParticipants} from './actions/calls';
            ...
            e.added.forEach((addedCall) => {
                ...
                addedCall.on('remoteParticipantsUpdated', (ev): void => {
                    ...
                    ev.removed.forEach((removedRemoteParticipant) => {
                        dispatch(setParticipants([...state.calls.remoteParticipants.filter(remoteParticipant => {
                            return remoteParticipant !== removedRemoteParticipant
                        })]))
                    });
                });
